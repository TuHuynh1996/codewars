...
public class Kata {
     ...
     * the gravity in the box is pulling the cubes downwards. When Bob switches the gravity, it begins to pull all the
     * cubes to a certain side of the box, d, which can be either 'L' or 'R' (left or right). Below is an example of what
    ...
    private static int[] negativeArr(int[] arr) {
